...
dominion.controller('dominionController', function($scope){
	...
	$scope.generate = function(){
		...
		if ($scope.activeExpansions.length > 0){
			...
			var hermitFlag = false; //Check if there is a hermit in the Kingdom.
			...
			//Always On
			if ($scope.colPlat === "on"){
				$scope.setup.push("Colonies and Platinums");
			}
			...
			//Total Random. 40% chance of getting Colones and Platinums.
